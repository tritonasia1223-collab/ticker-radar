...
import { Radar, Users, Landmark, UserSearch, Star, Moon, Sun, History, Layers, Building2, Blocks, Presentation, Pencil, Globe, Server } from "lucide-react";
...
const NAV = [
  ...
  { href: "/datacenters", label: "미국 데이터센터", icon: Server },
